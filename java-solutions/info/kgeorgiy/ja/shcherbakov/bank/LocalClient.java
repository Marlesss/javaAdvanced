...
public final class LocalClient {
    ...
    public static void main(final String... args) throws RemoteException {
        ...
        if (args.length != 5 || Arrays.stream(args).anyMatch(Objects::isNull)) {
            ...
            System.err.println("LocalClient name surname passportNumber accountId amountDelta");
            return;
        }
        try {
            ...
            AbstractClient.workClient(bank, true, name, surname, passport, accountId, amountDelta);
